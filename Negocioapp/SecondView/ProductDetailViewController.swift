...
class ProductDetailViewController: UIViewController {
    ...
    var product = Product(image: UIImage(named: "hipster gradient")!, title: "This is not supposed to appear", price: 9001)
    ...
    override func viewDidLoad() {
        ...
        //Escondemos el navigation bar para que el cliente no escape 
