...
class CartModalViewController: UIViewController {
    ...
    var productListCartControl: BotanasViewController! //Para inyectar código
    ...
    @IBAction func removeFromCart(_ sender: UIButton) {
        let alert = UIAlertController(title: "Espera!", message: "Quiere remover el platillo?",     preferredStyle: .alert)
        self.present(alert, animated: true, completion: nil)
        alert.addAction(UIAlertAction(title: "Quitar 😞", style: .default, handler: { (action) in
